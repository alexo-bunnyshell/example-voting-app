...
describe("cast a vote", function () {
    ...
    it("should add a note and display on the page", async function () {
      ...
      */
        ...
        let chromeUrl = process.env.CHROME_URL || "http://localhost:3000/webdriver";
        ...
        console.log("URL_RESULT: " + resultUrl);
        console.log("CHROME_URL: " + chromeUrl);
        ...
        try {
            ...
            for (let i = 0; i < numberOfClicks; i++) {
                ...
                driver = await new Builder().forBrowser("chrome")
                    ...
                    .usingServer(chromeUrl || 'http://localhost:3000/webdriver')
